...
In this tutorial, we'll create a Kubernetes v1.9.0 cluster on Digital Ocean.
...
10.132.110.130   Ready     10m       v1.9.0
10.132.115.81    Ready     10m       v1.9.0
10.132.124.107   Ready     10m       v1.9.0
```
