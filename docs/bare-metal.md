...
In this tutorial, we'll network boot and provision a Kubernetes v1.9.0 cluster on bare-metal.
...
node1.example.com   Ready     11m       v1.9.0
node2.example.com   Ready     11m       v1.9.0
node3.example.com   Ready     11m       v1.9.0
```
