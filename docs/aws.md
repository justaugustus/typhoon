...
In this tutorial, we'll create a Kubernetes v1.9.0 cluster on AWS.
...
ip-10-0-12-221   Ready     34m       v1.9.0
ip-10-0-19-112   Ready     34m       v1.9.0
ip-10-0-4-22     Ready     34m       v1.9.0
```
