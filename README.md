...
* Kubernetes v1.9.0 (upstream, via [kubernetes-incubator/bootkube](https://github.com/kubernetes-incubator/bootkube))
...
yavin-controller-0.c.example-com.internal     Ready    6m     v1.9.0
yavin-worker-jrbf.c.example-com.internal      Ready    5m     v1.9.0
yavin-worker-mzdm.c.example-com.internal      Ready    5m     v1.9.0
```
